...
public class FinalApplication {
	...
	CommandLineRunner run(UserService userService, ProductService productService) {
		return args -> {
			...
			productService.addProduct(new Product("MacBook Pro 14 inch M1 Pro 2021", Arrays.asList("42.790.000","49.990.000","64.400.000"), Arrays.asList("Gray","Silver"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/44/285958/s16/apple-macbook-pro-m2-2022-16gb-256gb-xa%CC%81m-650x650.png","https://cdn.tgdd.vn/Products/Images/44/285958/s16/apple-macbook-pro-m2-2022-16gb-256gb-bac-1-2-650x650.png"), Arrays.asList("RAM 16 GB - SSD 512 GB","RAM 16 GB - SSD 1 TB","RAM 32 GB - SSD 512 GB"), "", 0, "mac","Macbook Pro"));
			productService.addProduct(new Product("MacBook Pro 16 inch M1 Pro 2021", Arrays.asList("49.990.000","57.290.000","79.790.000"), Arrays.asList("Gray","Silver"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/44/285958/s16/apple-macbook-pro-m2-2022-16gb-256gb-xa%CC%81m-650x650.png","https://cdn.tgdd.vn/Products/Images/44/285958/s16/apple-macbook-pro-m2-2022-16gb-256gb-bac-1-2-650x650.png"), Arrays.asList("RAM 16 GB - SSD 512 GB","RAM 16 GB - SSD 1 TB","RAM 32 GB - SSD 1 TB"), "", 0, "mac","Macbook Pro"));
...
//			productService.addProduct(new Product("MacBook Pro M1 2022 8-core GPU", Arrays.asList("35.990.000"), Arrays.asList("Dark Blue"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/44/289472/s16/apple-macbook-air-m2-2022-16gb-256gb-xanh-650x650.png"), Arrays.asList("RAM 16 GB - SSD 256 GB"), "", 0, "mac","Macbook Pro"));
//			productService.addProduct(new Product("MacBook Air 2020 8-core GPU", Arrays.asList("23.990.000"), Arrays.asList("Dark Blue"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/44/289472/s16/apple-macbook-air-m2-2022-16gb-256gb-xanh-650x650.png"), Arrays.asList("RAM 16 GB - SSD 256 GB"), "", 0, "mac","Macbook Air"));
//			productService.addProduct(new Product("MacBook Pro 2019 8-core GPU", Arrays.asList("38.990.000"), Arrays.asList("Gray", "Silver"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/44/285958/s16/apple-macbook-pro-m2-2022-16gb-256gb-xa%CC%81m-650x650.png", "https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_75/https://cdn.tgdd.vn/Products/Images/44/285958/s16/apple-macbook-pro-m2-2022-16gb-256gb-xa%CC%81m-650x650.png"), Arrays.asList("RAM 16 GB - SSD 256 GB"), "", 0, "mac","Macbook Pro"));
			//ipad
...
//			productService.addProduct(new Product("iPad Pro M1 12.9\" WiFi Cellular 128GB", Arrays.asList("35.990.000", "38.990.000"), Arrays.asList("Gray", "Silver"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/522/295468/s16/iPad-Pro-M2-129-5G-grey-thumb-650x650.png","https://cdn.tgdd.vn/Products/Images/522/295468/s16/iPad-Pro-M2-129-5G-sliver-thumb-650x650.png"), Arrays.asList("128GB","256GB"), "", 0, "ipad","iPad Pro"));
//			productService.addProduct(new Product("iPad Pro M1 11 inch WiFi Cellular", Arrays.asList("27.490.000"), Arrays.asList("Gray"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/522/295458/s16/iPad-Pro-M2-11-5G-grey-thumb-650x650.png"), Arrays.asList("128GB"), "", 0, "ipad","iPad Pro"));
//			productService.addProduct(new Product("iPad Pro 2019 12.9\" WiFi", Arrays.asList("35.990.000", "38.990.000"), Arrays.asList("Gray", "Silver"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/522/295468/s16/iPad-Pro-M2-129-5G-grey-thumb-650x650.png","https://cdn.tgdd.vn/Products/Images/522/295468/s16/iPad-Pro-M2-129-5G-sliver-thumb-650x650.png"), Arrays.asList("128GB","256GB"), "", 0, "ipad","iPad Pro"));
//			productService.addProduct(new Product("iPad Pro 2019 11 inch WiFi Cellular", Arrays.asList("27.490.000"), Arrays.asList("Gray"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/522/295458/s16/iPad-Pro-M2-11-5G-grey-thumb-650x650.png"), Arrays.asList("128GB"), "", 0, "ipad","iPad Pro"));

//			userService.deleteUserByEmail("vthuan26644@gmail.com");
