...
public class FinalApplication {
	...
	CommandLineRunner run(UserService userService, ProductService productService) {
		return args -> {
			...
			productService.addProduct(new Product("iPhone 13 Pro Max", Arrays.asList("33.490.000","36.490.000"), Arrays.asList("Gold","Black"), Arrays.asList("https://cdn.tgdd.vn/Products/Images/42/289700/s16/iPhone-14-Pro-series-%20(2)-650x650.png", "https://cdn.tgdd.vn/Products/Images/42/289700/s16/iPhone-14-Pro-series-%20(4)-650x650.png"), Arrays.asList("128GB","256GB"), "", 0, "iphone","iPhone 13"));
			//mac
